...
+ a GenomicRanges object of genomic regions and specifically named columns,
+ a tibble or data.frame of genomic regions and specifically named columns, or 
...
By default the chromosomal coordinates are 0-based.
...
```{r apply_downloaded_blacklist_bed, eval=FALSE}
filterRegions(
  data = data_center_expand,
...
```
```{r view_black_list_annotationhub, eval=FALSE}
blacklist_ah
```

```{r apply_annotationhub_blacklist, eval=FALSE}
filterRegions(
  data = data_center_expand,
